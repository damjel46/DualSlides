            ...
            <div className="space-y-4 p-6">
                ...
                {schedule.slots.map((slot, idx) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="shrink-0 text-xs text-ds-text-muted">~</span>
                      <input
                        type="time"
                        value={slot.end_time}
                          ...
                          <div key={mid} className="space-y-1.5">
                            <div className="flex items-center justify-between">
                              ...
                              <button
                                ...
                                className="flex items-center gap-1 rounded-md border border-ds-border bg-ds-card px-2 py-1 text-[10px] text-ds-text-muted transition hover:bg-ds-accent/10 hover:text-ds-accent-light hover:border-ds-accent/20"
                              >
                            ...
                            {folders.length === 0 ? (
                              <div className="rounded-lg border border-dashed border-ds-border bg-ds-bg/20 px-3 py-2 text-center text-[10px] text-ds-text-muted">
              ...
              {schedule.slots.length < 6 ? (
                <button
                  ...
                  className="flex w-full items-center justify-center gap-1.5 rounded-lg border border-dashed border-ds-border bg-ds-card py-2.5 text-xs text-ds-text-muted transition hover:border-ds-accent/30 hover:bg-ds-accent/5 hover:text-ds-accent-light"
                >
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                  </svg>
